...
- *[ACL'24]* Shuo Zhang, Liangming Pan, _Junzhou Zhao*_, and William Yang Wang. "The Knowledge Alignment Problem:
...
- *[WWW'24]* Chenxu Wang, Xichan Nie, Jinfeng Chen, Pinghui Wang, _Junzhou Zhao_, and Xiaohong Guan. "SMUG: Sand Mixing
  for Unobserved Class Detection in Graph Few-Shot Learning". In /Proceedings of the ACM on Web Conference/, 2024.
  ~CCF-A~ ~图数据~ ~小样本学习~

- *[ICDE'24]* Tao Duan, _Junzhou Zhao*_, Shuo Zhang, Jing Tao, and Pinghui Wang. "Representation Learning of Tangled
  Key-Value Sequence Data for Early Classification". In /Proceedings of the 41st IEEE International Conference on Data
  Engineering (ICDE)/, 2024. [[[https://arxiv.org/abs/2404.07454][arXiv]]][[[file:assets/ICDE2024_slides.pdf][slides]]][[[file:assets/ICDE2024_poster.pdf][poster]]] ~CCF-A~ ~数据流~ ~表示学习~

- *[TON'24]* _Junzhou Zhao_, Pinghui Wang, Wei Zhang, Zhaosong Zhang, Maoli Liu, Jing Tao, and John C.S. Lui. "Tracking
  Influencers in Decaying Social Activity Streams with Theoretical Guarantees". /IEEE/ACM Transactions on Networking
  (TON)/, 32(2):1461-1476, 2024. ~CCF-A~ ~数据流~ ~图数据~ ~在线优化~ ~近似算法~
...
- *[AAAI'23]* Shuo Zhang, _Junzhou Zhao*_, Pinghui Wang, Tianxiang Wang, Zi Liang, Jing Tao, Yi Huang, and Junlan Feng.
...
- *[IJCAI'22]* Shuo Zhang, _Junzhou Zhao*_, Pinghui Wang, Yu Li, Yi Huang, and Junlan Feng. "Think Before You Speak:
...
- *[AAAI'21]* Shuo Zhang, _Junzhou Zhao*_, Pinghui Wang, Nuo Xu, Yang Yang, Yiting Liu, Yi Huang, and Junlan Feng.
...
- *[TKDE'18]* Pinghui Wang, _Junzhou Zhao*_, Xiangliang Zhang, Zhenhua Li, Jiefeng Cheng, John C.S. Lui, Don Towsley,
...
- *[KAIS'18]* Pinghui Wang, _Junzhou Zhao*_, Xiangliang Zhang, Jing Tao, and Xiaohong Guan. "SNOD: A Fast Sampling Method
  of Exploring Node Orbit Degrees for Large Graphs". /Knowledge and Information Systems (KAIS)/, 2018. ~图采样~ ~图数据~

- *[KAIS'18]* Pinghui Wang, _Junzhou Zhao*_, John C.S. Lui, Don Towsley, and Xiaohong Guan. "Fast Crawling Methods of
  Exploring Content Distributed Over Large Graphs". /Knowledge and Information Systems (KAIS)/, 2018. ~图数据~ ~图采样~
  ~近似算法~

- *[KAIS'18]* Pinghui Wang, _Junzhou Zhao*_, Bruno Ribeiro, John C.S. Lui, Don Towsley, and Xiaohong Guan. "Practical
...
- *[ICDE'16]* Pinghui Wang, John C.S. Lui, Don Towsley, and _Junzhou Zhao_. "Minfer: A Method of Inferring Motif
