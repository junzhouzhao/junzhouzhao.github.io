...
- *[ACL'24]* Shuo Zhang, Liangming Pan, _Junzhou Zhao_, and William Yang Wang. "The Knowledge Alignment Problem:
  Bridging Human and External Knowledge for Large Language Models". /Findings of ACL/, 2024. [[[https://arxiv.org/abs/2305.13669][arXiv]]] ~CCF-A~ ~大模型~
  ~幻想~ ~知识对齐~

- *[WWW'24]* Chenxu Wang, Xichan Nie, Jinfeng Chen, Pinghui Wang, _Junzhou Zhao_, and Xiaohong Guan. "SMUG: Sand Mixing
  for Unobserved Class Detection in Graph Few-Shot Learning". In /Proceedings of the ACM on Web Conference/, 2024. ~图数
  据~ ~小样本学习~
