...
[[[file:assets/MLDMAImap.pdf][机器学习、数据挖掘以及人工智能研究领域的主流国际会议参考]]（[[https://www.kamishima.net/archive/MLDMAImap.pdf][来源]]）]

- *[IJCAI'22]* Shuo Zhang, _Junzhou Zhao_, Pinghui Wang, Yu Li, Yi Huang, Junlan Feng. "Think Before You Speak:
  Improving Multi-action Dialog Policy by Planning Single-Action Dialogs". /IJCAI/ 2022. ~NLP~ ~对话系统~

+ *[ICDE'22]* Juxiang Zeng, Pinghui Wang, Lin Lan, _Junzhou Zhao_, Feiyang Sun, Jing Tao, Junlan Feng, Min Hu, and
  Xiaohong Guan. "Accurate and Scalable Graph Neural Networks for Billion-Scale Graphs". /IEEE ICDE/ 2022. ~图神经网络~

+ *[KDD'21]* Runze Lei, Pinghui Wang, Rundong Li, Peng Jia, _Junzhou Zhao_, Xiaohong Guan, and Chao Deng. "Fast Rotation
  Kernel Density Estimation over Data Streams". /ACM SIGKDD/ 2021. ~数据流~ ~联邦学习~

+ *[KDD'21]* _Junzhou Zhao_, Pinghui Wang, Chao Deng, and Jing Tao. "Temporal Biased Streaming Submodular Optimization".
  /ACM SIGKDD/ 2021. [[[file:assets/KDD21_SSO_slides.pdf][slides]]] ~数据流~ ~在线优化~ ~近似算法~
...
+ *[TMC'21]* Feiyang Sun, Pinghui Wang, _Junzhou Zhao_, Nuo Xu, Juxiang Zeng, Jing Tao, Kaikai Song, Chao Deng, John
  ...
  /IEEE Transactions on Mobile Computing/, 2021. ~时空数据挖掘~
...
+ *[KAIS'21]* _Junzhou Zhao_, Pinghui Wang, Zhouguo Chen, Jianwei Ding, John C.S. Lui, Don Towsley, and Xiaohong Guan.
  ...
  Information Systems (KAIS)/, 2021. ~异常检测~ ~图数据流~ [[[https://arxiv.org/abs/1708.09089][arXiv]]]
...
+ *[ACL'20]* Nuo Xu, Pinghui Wang, Long Chen, Li Pan, Xiaoyan Wang and _Junzhou Zhao_. "Distinguish Confusing Law
  ...
  Computational Linguistics (ACL)/, 2020. ~NLP~ [[[https://arxiv.org/abs/2004.02557][arXiv]]]

+ *[WWW'20]* Yiyan Qi, Pinghui Wang, Yuanming Zhang, _Junzhou Zhao_, Guangjian Tian, and Xiaohong Guan. "Fast Generating
  A Large Number of Gumbel-Max Variables". /The Web Conference (WWW)/, 2020. ~局部敏感哈希算法~ [[[https://arxiv.org/abs/2002.00413][arXiv]]]
...
+ *[ICDE'20]* _Junzhou Zhao_, Pinghui Wang, Jing Tao, Shuo Zhang, and John C.S. Lui. "Continuously Tracking Core Items
  ...
  Engineering (ICDE)/, 2020. ~数据流~ ~在线优化~ ~近似算法~ [[[file:assets/ICDE2020_full_version.pdf][full paper]]][[[file:assets/ICDE2020_slides.pdf][slides]]][[[file:assets/ICDE2020_poster.pdf][poster]]]
...
+ *[IJCAI'19]* Nuo Xu, Pinghui Wang, Long Chen, Jing Tao, and Junzhou Zhao. "MR-GNN: Multi-Resolution and Dual Graph
  ...
  Conference on Artificial Intelligence (IJCAI)/, 2019. ~图表示学习~ [[[https://arxiv.org/abs/1905.09558][arXiv]]]
...
+ *[AAAI'19]* _Junzhou Zhao_, S. Shang, Pinghui Wang, John C.S. Lui, and Xiangliang Zhang. "Submodular Optimization over
  ...
  (AAAI)/, 2019. ~数据流~ ~在线优化~ ~近似算法~ [[[https://arxiv.org/abs/1811.05652][arXiv]]]
...
+ *[ICDE'19]* _Junzhou Zhao_, S. Shang, Pinghui Wang, John C.S. Lui, and Xiangliang Zhang. "Tracking Influential Nodes
  ...
  Engineering (ICDE)/, 2019. ~社交网络~ ~影响力最大化~ ~近似算法~ [[[https://arxiv.org/abs/1810.07917][arXiv]]][[[file:assets/ICDE19_poster.pdf][poster]]]
...
+ *[DMKD'19]* _Junzhou Zhao_, Pinghui Wang, John C.S. Lui, Don Towsley, and Xiaohong Guan. "Sampling Online Social
  Networks by Random Walk with Indirect Jumps". /Data Mining and Knowledge Discovery (DMKD)/, 2019. ~图采样~ ~近似算法~
...
+ *[TKDE'18]* Pinghui Wang, _Junzhou Zhao_, Xiangliang Zhang, Zhenhua Li, Jiefeng Cheng, John C.S. Lui, Don Towsley,
  ...
  /IEEE Transactions on Knowledge and Data Engineering (TKDE)/, 2018. ~子图模式挖掘~ [[[file:assets/TKDE18_poster.pdf][poster]]]
...
- *[ICDE'15]* _Junzhou Zhao_, John C.S. Lui, Don Towsley, Pinghui Wang, and Xiaohong Guan. "A Tale of Three Graphs:
  ...
  Data Engineering (ICDE)/, 2015. ~图采样~ ~近似算法~ [[[file:assets/ICDE2015.pdf][pdf]]]

- *[TIFS'14]* Pinghui Wang, Xiaohong Guang, _Junzhou Zhao_, Jing Tao, and Tao Qin. "A New Sketch Method for Measuring
  Host Connection Degree Distribution". /IEEE Transactions on Information Forensics and Security (TIFS)/, 2014. ~异常检
  测~ ~Sketch算法~
...
- *[ICDE'13]* Pinghui Wang, _Junzhou Zhao_, John C.S. Lui, Don Towsley, and Xiaohong Guan. "Sampling Node Pairs Over
  Large Graphs". In /Proceedings of the 29th IEEE International Conference on Data Engineering (ICDE)/, 2013. ~图采样~
  ~近似算法~ [[[file:assets/ICDE2013.pdf][pdf]]]
...
- *[WebSci'10]* Zhaohui Wu, Lu Jiang, Zhenhua Tian, Jun Liu, Qinghua Zheng, and _Junzhou Zhao_. "A Peep at Pornography
  Web in China". In /Proceedings of the Web Science Conference (WebSci)/, 2010. ~Web挖掘~ [[[file:assets/WebSci2010.pdf][pdf]]][[[http://www.danwei.com/peoples-pornography-an-interview-with-katrien-jacobs][Media]]]
