...
- Y. Qi, P. Wang, Y. Zhang, *J. Zhao*, G. Tian and X. Guan. "Fast Generating A Large Number of
  Gumbel-Max Variables". The Web Conference (WWW), 2020.

- *J. Zhao*, P. Wang, S. Zhang, J. C.S. Lui. "Continuously Tracking Core Items in Data Streams with
  Probabilistic Decays". IEEE International Conference on Data Engineering (ICDE), 2020.
