...
* Biography
  ...
  Chinese University of Hong Kong]] (CUHK). He received a Ph.D. degree in Control Science &
  Engineering and a B.S. degree in Automation Science & Technology, both from [[http://en.xjtu.edu.cn/][Xi’an Jiaotong
  University]] (XJTU). His research interests focus on large-scale graph/network measurement, mining,
  and optimization, with a particular interest in online social network applications (a.k.a. the
  [[https://en.wikipedia.org/wiki/Network_science][network science]]).
