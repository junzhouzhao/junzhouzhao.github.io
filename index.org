...
from XJTU. His research interests focus on graph/streaming/networking data analysis, algorithm
design, privacy protection, and data security.
...
* Research
- 数据安全与隐私保护：加密网络流量分析、密码学与隐私计算及隐私保护机器学习、大模型与智能体安全可信等。
- 大数据近似计算与优化：大规模网络/图/流数据近似计算与优化算法、在线学习理论等。

#+ATTR_HTML: :width 500px
[[file:images/wordcloud.png]]

* Courses
- 本科生课程 MATH200327：概率统计与随机过程，春
- 本科生课程 COMP401227：现代密码学，春上
- 研究生课程 AUTO712705：密码学理论与实践，秋下
