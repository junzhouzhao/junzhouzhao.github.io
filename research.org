...
响力的节点。该方法可以推广到一般数据流中的在线优化问题求解，相关工作发表在 KDD、ICDE、AAAI 等国际会
议上。

- Temporal Biased Streaming Submodular Optimization. ACM SIGKDD, 2021. [[[file:assets/KDD21_SSO_slides.pdf][slides]]]
