...
* 大数据（Big Data）
  ...
  #+ATTR_HTML: :style margin-left:2em; width: 800px;
...
** 大图优化算法（Graph Optimization Algorithms）
  ...
  #+ATTR_HTML: :style margin-left:2em; width: 1200px;
  [[file:img/group.png]]
...
** 流数据在线优化算法（Online Optimization Algorithms）
  ...
  #+ATTR_HTML: :style margin-left:2em; width:600px; float: left;
  [[file:img/SSO1.png]]
  #+ATTR_HTML: :style margin-left:2em; width:500px;
...
* 学习理论（Learning Theory）
  ...
  #+ATTR_HTML: :style margin-left:2em; width: 1000px;
